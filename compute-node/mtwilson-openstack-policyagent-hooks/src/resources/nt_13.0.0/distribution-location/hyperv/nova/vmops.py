...
class VMOps(object):
    ...
    def _create_root_device(self, context, instance, root_disk_info,
                            vm_gen):
        path = None
        LOG.error("Inside _create_root_device")		
        ...
        LOG.info("Leaving _create_root_device")
    ...
    def _create_root_vhd(self, context, instance, rescue_image_id=None):
        ...
        LOG.debug("Inside _create_root_device")
    ...
    def _create_config_drive(self, instance, injected_files, admin_password,
        ...
        LOG.error(_LI('Using config drive for instance'), instance=instance)
    ...
    def reboot(self, instance, network_info, reboot_type):
        ...
        LOG.error("Rebooting instance", instance=instance)

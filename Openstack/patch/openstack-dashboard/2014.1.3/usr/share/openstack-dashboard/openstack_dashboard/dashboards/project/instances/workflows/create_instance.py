...
class SetInstanceDetailsAction(workflows.Action):
    ...
    # Abhay Dandekar
    # INTEL_DCG : Adding is_measured field to the dashboard

    #Start
    is_measured = forms.BooleanField(label=_("Measured Launch"),
                                          required=False)
    #End
...
class SetInstanceDetails(workflows.Step):
	## Abhay Dandekar : Update the is_measured flag 
	## IntelDCG
...
class LaunchInstance(workflows.Workflow):
	...
	## Abhay Dandekar : Update the is_measured flag from context
	is_measured = bool(context['is_measured'])
	...
	## Abhay Dandekar: Passing the is_measured flag to server_create
        try:

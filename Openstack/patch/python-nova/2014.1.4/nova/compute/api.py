...
class API(base.Base):
    ...
    def _validate_and_build_base_options(self, context, instance_type,
                                         ...
                                         key_data, security_groups, is_measured,
        ...
        for bdm in block_device_mapping:
            ...
            if bdm.get('image_id'):
                ...
                try:
                    ...
                    # NOTE(mdbooth): These values come from
                    # volume_glance_metadata in cinder. This is a simple
                    # key/value table, and all values are strings. We need to
                    # convert them to ints to avoid unexpected type errors.
                    image_meta['min_ram'] = int(properties.get('min_ram', 0))
                    image_meta['min_disk'] = int(properties.get('min_disk', 0))
                    # Volume size is no longer related to the original image
                    # size, so we take it from the volume directly. Cinder
                    # creates volumes in Gb increments, and stores size in Gb,
                    # whereas glance reports size in bytes. As we're returning
                    # glance metadata here, we need to convert it.
    ...
    def _create_instance(self, context, instance_type,
               ...
               key_name, key_data, security_groups, is_measured,
        ...
        base_options, max_net_count = self._validate_and_build_base_options(
                ...
                key_name, key_data, security_groups, is_measured, availability_zone,
    ...
    def create(self, context, instance_type,
               ...
               key_name=None, key_data=None, security_group=None, is_measured=None,
        ...
        return self._create_instance(
                               ...
                               min_count, max_count,
                               display_name, display_description,
                               key_name, key_data, security_group, is_measured,
                               availability_zone, user_data, metadata,
                               injected_files, admin_password,
                               access_ip_v4, access_ip_v6,
                               requested_networks, config_drive,

...
class ServerManager(base.BootingManagerWithFind):
    ...
    def _boot(self, resource_url, response_key, name, image, flavor,
              ...
              max_count=None, security_groups=None, key_name=None, is_measured=False,
        ...
        :param key_name: (optional extension) name of keypair to inject into
                         the instance
        :param is_measured: to boot measured or non-measured
        ...
        # Abhay Dandekar
        # DCG : updating with is_measured flag
        body["server"]["is_measured"] = is_measured
    ...
    # Abhay Dandekar
    # DGC : adding is_measured flag to create

    def create(self, name, image, flavor, meta=None, files=None,
               reservation_id=None, min_count=None,
               max_count=None, security_groups=None, userdata=None,
               key_name=None, is_measured=False, availability_zone=None,
        ...
        :param is_measured : flag to boot server as measured or non-measured
        :param availability_zone: Name of the availability zone for instance
                                  placement.
        ...
        boot_kwargs = dict(
            ...
            key_name=key_name, is_measured=is_measured, availability_zone=availability_zone,
